...
class BanderaJugador extends StatelessWidget {
  ...
  const BanderaJugador({super.key, required this.codigoBandera, this.tamanio = 40, this.defaultNegro = false});
  ...
  Widget build(BuildContext context) {
    return Visibility(
      ...
      replacement:
          Image.asset('assets/images/panel_${defaultNegro ? 'negro' : 'blanco'}.png', fit: BoxFit.fill, width: tamanio + 15, height: tamanio),
      child: ClipOval(
